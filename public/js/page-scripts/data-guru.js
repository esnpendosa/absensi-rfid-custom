        ...
        resultBox.innerHTML = `
            <div class="bg-white rounded-xl border border-purple-100 shadow-sm p-4 text-left">
                ...
                <div class="flex gap-2 justify-end">
                    ...
                    <button type="button" onclick="viewGuru(${JSON.stringify(guru).replace(/"/g, '&quot;')})" class="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1">
